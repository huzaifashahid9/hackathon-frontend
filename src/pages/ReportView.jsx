...
const ReportView = () => {
  ...
  const { currentReport: report, loading } = useSelector(
    (state) => state.reports
  );
        ...
        {report.isProcessed && report.aiSummary ? (
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              {/* Abnormal Values */}
              {report.aiSummary.abnormalValues &&
              ...
              {/* Recommended Foods */}
              {report.aiSummary.recommendedFoods &&
                report.aiSummary.recommendedFoods.length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">
                      ✅ Recommended Foods
                    </h3>
